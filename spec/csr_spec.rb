...
describe R509::CSR do
  ...
  context "when passing a subject array" do
    ...
    it "generates a matching csr when supplying raw oids" do
      ...
      expect(csr.subject.to_s).to eq("/CN=common name/businessCategory=business category/L=locality/jurisdictionC=jurisdiction oid openssl typically does not know")
    end
